...
export const callTaskListAPI = (_page = 1, _limit = 10, _search = "") => {
...
export const callAddClientApiAction = (_req) => {
  return (_dispatch, _getState) => {
    return fetchClient.post(`${constants.API.DASHBOARD.ADD_CLIENT}`, _req);
  };
};
